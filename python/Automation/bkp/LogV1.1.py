...
#To run this program enter command :python <script name> <comport> <baudrate> <maintime> <subtime>
#For example python LogV1.1.py /dev/ttyACM0 460800 1:1:1 0:0:1 will logs the data for 1hr1min1sec with 1sec logging frequency, 460800 baudrate.
class Node(object):
    def __init__(self):
