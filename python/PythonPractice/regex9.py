...
Show Source
«
indexmodules |next |previous | Python » 3.8.5 Documentation » The Python Standard Library » Text Processing Services »
Quick search
  |
© Copyright 2001-2020, Python Software Foundation.
The Python Software Foundation is a non-profit corporation. Please donate.

Last updated on Aug 13, 2020. Found a bug?
Created using Sphinx 2.3.1."""
regex = re.compile(r'[^\W\d]+') # ^ is for negative cases
                            #we searching for one or more letters, anything that is not a digit and not a _, not a letter
listOfWords = regex.findall(stg)
